# Projetos em Python – Biblioteca math
...
### Recursos utilizados:
- `math.sqrt()` para cálculo da raiz quadrada  
- Método `.is_integer()` para validação de números inteiros  
...
### Recursos utilizados:
- `math.pi` para uso da constante π  
- `math.pow()` para potenciação  
- Entrada de dados com `input()`  
- Cálculo e formatação de valores numéricos  

## 🧠 Objetivo

Fortalecer a base em **Python**, **lógica de programação** e **pensamento matemático**, como parte da preparação para estudos em **Data Science e análise de dados**.

---

📌 Desenvolvido para fins educacionais e aprendizado contínuo.
